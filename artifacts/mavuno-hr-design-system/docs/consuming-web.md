...
Read `artifacts/mavuno-hr-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/mavuno-hr-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/mavuno-hr-design-system/styles.css";
```
...
`node_modules/@workspace/mavuno-hr-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/mavuno-hr-design-system/components/ui/button";
import { cn } from "@workspace/mavuno-hr-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/mavuno-hr-design-system/hooks/use-toast";
```
...
`@workspace/mavuno-hr-design-system/components/ui/button`. Run the app's typecheck
