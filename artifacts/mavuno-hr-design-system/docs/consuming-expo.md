...
Read `artifacts/mavuno-hr-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/mavuno-hr-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/mavuno-hr-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/mavuno-hr-design-system/lib/native-theme";
import { useColors } from "@workspace/mavuno-hr-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/mavuno-hr-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/mavuno-hr-design-system/components/native/badge";
import { Button } from "@workspace/mavuno-hr-design-system/components/native/button";
import { Card } from "@workspace/mavuno-hr-design-system/components/native/card";
```
...
Import and render
`@workspace/mavuno-hr-design-system/components/native/button`, then run Expo
