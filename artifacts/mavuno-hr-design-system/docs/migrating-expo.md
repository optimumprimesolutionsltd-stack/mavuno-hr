...
Read `artifacts/mavuno-hr-design-system/docs/AGENTS.md` and
`artifacts/mavuno-hr-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/mavuno-hr-design-system/lib/native-theme` and
  `@workspace/mavuno-hr-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/mavuno-hr-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/mavuno-hr-design-system` and retains only
