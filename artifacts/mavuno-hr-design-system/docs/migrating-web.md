# Migrating web UI to Mavuno HR Design System

Read `artifacts/mavuno-hr-design-system/docs/AGENTS.md` and
`artifacts/mavuno-hr-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/mavuno-hr-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/mavuno-hr-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/mavuno-hr-design-system/hooks/use-toast`
