...
export function generateP9Pdf(data: P9FormData): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    const doc = new PDFDocument({
      ...
      layout: "portrait",
      margin: 0,
      info: { Title: `P9 Annual Tax Return ${data.year}`, Author: "Zawadi HR", Subject: "KRA P9" },
    });
    ...
    doc.font("Helvetica").fontSize(6).fill("#666666")
       .text("Generated by Zawadi HR. This form should be submitted to KRA with the employer's annual tax return.", PL, y, { width: PW, align: "center" });
