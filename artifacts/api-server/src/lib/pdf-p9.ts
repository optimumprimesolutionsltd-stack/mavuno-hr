...
export function generateP9Pdf(data: P9FormData): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    const doc = new PDFDocument({
      ...
      layout: "landscape",
      margin: 0,
      info: { Title: `P9 Annual Tax Return ${data.year}`, Author: "Mavuno HR", Subject: "KRA P9" },
    });
    ...
    doc.font("Helvetica").fontSize(6).fill("#667085")
       .text(`Generated by Mavuno HR  •  P9 ${data.year}  •  ${data.rows.length} employees`, PL, y, { width: PW, align: "center" });
