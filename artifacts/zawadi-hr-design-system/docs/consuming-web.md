...
`artifacts/zawadi-hr-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/zawadi-hr-design-system/styles.css";
```
...
`node_modules/@workspace/zawadi-hr-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/zawadi-hr-design-system/components/ui/button";
import { cn } from "@workspace/zawadi-hr-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/zawadi-hr-design-system/hooks/use-toast";
```
...
`@workspace/zawadi-hr-design-system/components/ui/button`. Run the app's typecheck
