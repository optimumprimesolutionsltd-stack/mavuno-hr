...
`artifacts/zawadi-hr-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/zawadi-hr-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/zawadi-hr-design-system/lib/native-theme";
import { useColors } from "@workspace/zawadi-hr-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/zawadi-hr-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/zawadi-hr-design-system/components/native/badge";
import { Button } from "@workspace/zawadi-hr-design-system/components/native/button";
import { Card } from "@workspace/zawadi-hr-design-system/components/native/card";
```
...
Import and render
`@workspace/zawadi-hr-design-system/components/native/button`, then run Expo
