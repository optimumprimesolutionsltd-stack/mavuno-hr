...
`artifacts/zawadi-hr-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/zawadi-hr-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/zawadi-hr-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/zawadi-hr-design-system/hooks/use-toast`
