...
workspace package (`@workspace/zawadi-hr-design-system`): other artifacts depend
...
`@workspace/zawadi-hr-design-system/components/...`. Never use a `@/` alias inside
...
for `@workspace/zawadi-hr-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/zawadi-hr-design-system` as a `workspace:*` dependency,
run `pnpm install`, and import directly from this package.

Read only the guides required by the current task:

- Building or styling web UI: `artifacts/zawadi-hr-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/zawadi-hr-design-system/docs/consuming-expo.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/zawadi-hr-design-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/zawadi-hr-design-system/docs/migrating-expo.md`
