    ...
    <div className="space-y-4">
      ...
      <section className="rounded-lg border bg-card p-5 text-card-foreground">
        ...
        <div className="mt-4">
          <Guidelines
            items={[
              { kind: 'do', text: 'Use emerald for primary actions, focus, and positive progress.' },
              { kind: 'do', text: 'Use mono type for amounts, identifiers, dates, and dense operational labels.' },
              { kind: 'do', text: 'Keep surfaces tight, structured, and easy to scan in data-heavy workflows.' },
              { kind: 'dont', text: 'Do not introduce decorative gradients or loose, oversized rounded cards.' },
            ]}
          />
        </div>
      </section>
    ...
    <div className="space-y-8 rounded-xl border bg-card p-6 text-card-foreground">
      <section>
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Inter carries UI copy. JetBrains Mono is reserved for operational data,
          identifiers, dates, labels, and dense numeric tables.
        </p>
        <p className="mt-5 font-mono text-lg text-primary">KES 1,250,000 · EMP0002 · 2026-07</p>
      </section>
