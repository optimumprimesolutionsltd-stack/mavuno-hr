      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="max-w-3xl">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed mb-10 max-w-2xl font-medium">
            Zawadi HR handles complex KRA compliance, automated payroll, and leave management, so you can focus on building your team. Independent, secure, and built for modern Kenyan businesses.
          </p>
