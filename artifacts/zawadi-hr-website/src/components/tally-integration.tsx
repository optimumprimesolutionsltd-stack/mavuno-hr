        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative w-full max-w-md">
              ...
              <div className="flex items-center justify-between">
                <div className="w-24 h-24 rounded-2xl bg-white border border-border shadow-xl flex items-center justify-center p-4 z-10 relative">
                  <img src={markSvg} alt="Zawadi HR" className="w-full h-full object-contain" />
                </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-8">
              Already using Tally for accounting? Zawadi HR bridges the gap. Sync payroll data directly to Tally ERP 9 and TallyPrime. No manual journal entries, no reconciliation headaches. Just smooth, automated syncing.
            </p>
            <p className="text-lg text-secondary font-medium mb-8">
              Don't use Tally? No problem. Zawadi HR works perfectly as a standalone, powerful HR platform.
            </p>
