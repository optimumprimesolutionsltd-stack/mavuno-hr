...
}).describe('Flat, not nested -- matches the actual POST \/login (and \/clerk\/session) response shape in routes\/auth.ts. employeeId is null for an admin\/HR account with no linked employee record.\n')
...
export const CreateEmployeeBody = zod.object({
  ...
  "educationLevel": zod.enum(['none', 'primary', 'secondary', 'certificate', 'diploma', 'bachelor', 'master', 'phd', 'other']).optional(),
  "nokName": zod.string().optional(),
...
export const ListLoanRequestsResponseItem = zod.object({
  ...
  "amount": zod.number(),
  "months": zod.number(),
  "interestRateBps": zod.number().optional().describe('Basis points (100 = 1%). Only meaningful for sacco loans; 0 otherwise.'),
  "reason": zod.string().nullish(),
  "status": zod.string(),
